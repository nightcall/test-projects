...
var _RouteError = __webpack_require__(78);

var _RouteError2 = _interopRequireDefault(_RouteError);

var _PostList = __webpack_require__(28);
	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/post/:postId', component: _Post2.default }),
	...
	_createClass(PostList, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				this.state.canLoadMore ? _react2.default.createElement(
					'a',
					{ href: '#', onClick: function onClick(e) {
							e.preventDefault();_this3.loadPosts();
						} },
					'Load more posts'
				) : null
			);
...
var Post = function (_React$Component) {
	...
	function Post(props) {
		...
		_this.handleChangeAuthor = _this.handleChangeAuthor.bind(_this);
	...
	_createClass(Post, [{
		...
		value: function componentDidMount() {
			...
			fetch('/post', {
				...
				return _this3.setState({ post: post, isLoading: false });
			}).then(function () {
				return document.title = _this3.state.post.title;
			});
		}
	}, {
		key: 'render',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							null,
							'Pseudo :',
							_react2.default.createElement('input', { onChange: this.handleChangeAuthor, value: this.state.author }),
							_react2.default.createElement('br', null)
						),
						_react2.default.createElement('textarea', { onChange: this.handleChangeMessage, value: this.state.message }),
						_react2.default.createElement('br', null),
						_react2.default.createElement(
							'button',
							null,
					...
					this.state.post.comments.map(function (c, i) {
						return _react2.default.createElement(
							'p',
							{ key: i },
							_react2.default.createElement(
...
var RouteError = function (_React$Component) {
	_inherits(RouteError, _React$Component);

	function RouteError(props) {
		_classCallCheck(this, RouteError);

		return _possibleConstructorReturn(this, (RouteError.__proto__ || Object.getPrototypeOf(RouteError)).call(this, props));
	}

	_createClass(RouteError, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
