...
var _LoginBar = __webpack_require__(71);
...
var App = function (_React$Component) {
	...
	_createClass(App, [{
		...
		value: function componentDidMount() {
			...
			this.socket.on('update_clients_list', function (clients) {
				_this2.setState({ clientList: clients });
			});
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ id: 'container' },
				_react2.default.createElement(_LoginBar2.default, { isLoggedIn: this.state.isLoggedIn, name: this.state.name, onSubmit: this.login }),
				_react2.default.createElement(_Chat2.default, { isLoggedIn: this.state.isLoggedIn, name: this.state.name, clients: this.state.clientList, messages: this.state.messages, onSend: this.sendMessage })
			);
		}
	}]);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.props.clients.map(function (c) {
							return _react2.default.createElement(
								'h5',
								{ key: c.id },
								c.name
				...
				this.props.isLoggedIn ? _react2.default.createElement(
					'div',
					{ id: 'chat-input' },
					_react2.default.createElement('textarea', { onChange: this.handleChange, value: this.state.message }),
					_react2.default.createElement(
						'button',
